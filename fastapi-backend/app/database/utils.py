...
def create_page(db: Session, page_data: dict, ctx: TenantContext | None = None):
    ...
    page = Page(
        ...
        is_public=page_data.get('is_public', True),  # public by default — private is explicit (matches Page.is_public default + PageCreate schema)
