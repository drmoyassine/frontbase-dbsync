 ...
 * @frontbase/edge-core to the framework workspace's compiled output at
 * C:/Users/PC/OneDrive - studygram.me/VsCode/frontbase-framework/packages/edge-core/dist/index.js
 * — the SAME package the cf-full worker imports. A single source of truth, so
 * the SW and the worker can never drift.
 */
